...
def lower_jaxpr_to_triton_module(
  ...
  args = []
  block_infos = []
  for i, (arg_type, shape_dtype, block_mapping) in enumerate(
    ...
    if block_mapping is None:
      ...
      strides = pallas_utils.strides_from_shape(shape_dtype.shape)
      ...
      block_infos.append(BlockInfo(shape_dtype, block_mapping.block_shape))
